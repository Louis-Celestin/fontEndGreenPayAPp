...
export default function DashboardResponsableSection() {
  ...
  const barSeries = [
    {
      name: "Nombre",
      data: [stats.nbDemandesApprouveesCeMois, stats.nbDemandesRejeteesCeMois],
    },
  ];
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-yellow-100 rounded-lg text-center">
          <p className="text-gray-700">Demandes Approuvées ce Mois</p>
          <h3 className="text-xl font-bold">{stats.nbDemandesApprouveesCeMois}</h3>
        </div>
        <div className="p-4 bg-red-100 rounded-lg text-center">
          <p className="text-gray-700">Demandes Rejetées ce Mois</p>
          <h3 className="text-xl font-bold">{stats.nbDemandesRejeteesCeMois}</h3>
        </div>
      </div>
