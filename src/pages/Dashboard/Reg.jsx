...
export default function DashboardDG() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/demandes/stats/Reg", {
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-xl font-semibold text-gray-800 mb-4">
        Tableau de bord - Directeur Général (DG)
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-yellow-100 rounded-lg text-center">
          <p className="text-gray-700">Demandes en Attente</p>
          <h3 className="text-xl font-bold">{stats.nbDemandesEnAttenteValidation}</h3>
        </div>
      </div>
